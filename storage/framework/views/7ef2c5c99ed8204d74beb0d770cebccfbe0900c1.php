...
<html>
  <head>
    <title>Wzrd was Here@Wzrd</title>

    <!-- METADATA -->
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta property="og:title" content="Wzrd was Here@Wzrd" />
    <meta property="og:description" content="Wzrd was Here" />
    <meta
      property="og:image"
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary mt-3 border-danger navbar-login" data-bs-theme="light" >
        <div class="container" data-bs-theme="light">
          <a class="navbar-brand fs-4 fw-semibold" href="#">
            <img src="assets/img/Wzrd was Here-logo.png" alt="Logo" width="45" height="45" class="d-inline-block align-items-center" />
            Wzrd was Here
          </a>
      ...
      <div class="row m-2 justify-content-center">
        <div class="col-7 mt-5">
          <div class="content-box">
            <h1 class="fw-bold">Wzrd was Here.</h1>
      ...
      <div id="about" class="container text-center">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 p-4 mt-5">
              ...
              <p class="text-start pt-2">Kami adalah sahabat belajar yang akan membantu Anda dalam meraih keberhasilan cita-cita. Bergabunglah dengan Wzrd was Here dan tingkatkan wawasan untuk mencapai tujuan karier yang luar biasa!</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 p-4 mt-5">
            <h6 class="text-start fs-6 fw-medium text-primary">Fitur</h6>  
              ...
              <p class="text-start pt-2">Gali potensi diri bersama Wzrd was Here. Beragam kategori mentoring, magang, dan soft skill lainnya tersedia di Wzrd was Here</p>
    ...
    <section class="footer">
      ...
      <div class="container">
        ...
        <div class="footer-line">
          <p class="mt-4 text-center">Wzrd was Here Copyright © 2023. All Rights Reserved.</p>
        </div>
      </div>
...
<?php /**PATH /home/flxnzz/Documents/Code/Web Development/UniVuln/resources/views/index.blade.php ENDPATH**/ ?>