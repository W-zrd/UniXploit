            ...
            <div class="row ">
              ...
              <div class="col">
                <div class="mb-3">
                  ...
                  <input value="<?php echo e(old('title')); ?>" type="text" class="form-control" id="title" name="title" aria-describedby="judulPostHelp" style="border-radius: 20px">
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="mb-3">
                  ...
                  <input value="<?php echo e(old('author')); ?>" type="text" class="form-control" id="author" name="author" aria-describedby="authorHelp" style="border-radius: 20px">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col">
                <div class="mb-3">
                  ...
                  <input value="<?php echo e(old('url_event')); ?>" type="text" class="form-control" name="url_event" id="url_event" aria-describedby="urlHelp" style="border-radius: 20px">
...
<?php echo $__env->make('admin.layout.admin-generics', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/flxnzz/Documents/Code/Web Development/UniXploit/resources/views/admin/admin-create-event.blade.php ENDPATH**/ ?>